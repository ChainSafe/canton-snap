    ...
    <div className="dropdown" style={{ minWidth: 288 }}>
      ...
      {NETWORKS.map(net => (
        ...
        >
          ...
          <div>
            <p style={{ fontSize: 13, fontWeight: net.id === current ? 700 : 600, color: 'var(--text-primary)' }}>{net.name}</p>
          ...
          {net.id === current && (
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" style={{ marginLeft: 'auto' }}>
              <path d="M2 8 L6 12 L14 4" stroke="#ffb84d" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          )}
        </div>
      ))}
